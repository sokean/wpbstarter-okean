 ...
 */
if ( post_password_required() ) {     //ПРОВЕРЯЕТ ЗАЩИЩЕН ПОСТ ПАРОЛЕМ ИЛИ НЕТ
	return;
}
/**true|false. Логические: true, если нужно ввести пароль для просмотра поста или false,
 *если пост не защищен паролем.*/
?>
